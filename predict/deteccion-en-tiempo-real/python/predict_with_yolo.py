...
Similar a predict_without_opencv_windows.sh pero usando Python directamente.
"""
...
def procesar_camara(model, device):
    ...
    try:
        while True:
            ...
            # Salir si se presiona 'q' (requiere ventana abierta, pero podemos usar timeout)
            # Para modo headless, usar Ctrl+C
